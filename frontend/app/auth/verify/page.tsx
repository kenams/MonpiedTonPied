...
export default function VerifyRequestPage() {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        setMessage(null);
        try {
            const response = await fetch(apiUrl('/api/auth/email/resend'), {
                method: 'POST',
            ...
            setMessage(data.message || 'Lien envoye si le compte existe.');
        } catch (error) {
        ...
        <div className="min-h-screen">
            ...
            <div className="max-w-xl mx-auto px-6 py-16 space-y-6">
                ...
                <p className="text-sm text-[#b7ad9c]">
                    Saisis ton email ou pseudo pour recevoir un lien de verification.
                </p>
                {message && (
